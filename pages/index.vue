<template>
  <div class="container">
    <div>
      <el-row :gutter="16">
        <el-col :span="8">
          <el-card :body-style="{padding: '0px'}" style="height: 260px" class="animated fadeInUp card-box-shadow">
        ...
        <el-col :span="8">
          <el-card :body-style="{padding: '0px'}" style="height: 260px" v-if="userType == 2" class="animated fadeInUp card-box-shadow">
            <div class="padding-lr-10 padding-tb-10 color-muted">
              <el-row>
                <el-col :span="12">
          ...
          <el-card :body-style="{padding: '0px'}" style="height: 260px" v-if="userType == 4" class="animated fadeInUp card-box-shadow">
            <div class="padding-lr-10 padding-tb-10 color-muted">
              <el-row>
                <el-col :span="12">
    ...
    <div class="margin-top-20 custom-card-layout">
      <el-row :gutter="16">
        <el-col :span="16">
          <el-card :body-style="{padding: '0px'}" style="height: 240px" class="animated fadeInUp card-box-shadow">
          ...
          <div>
            <el-tabs :active-name="activeName" type="border-card" class="margin-top-20 animated fadeInUp card-box-shadow" style="height: 38px" @tab-click="changeNotice">
              <el-tab-pane label="通知" name="1"></el-tab-pane>
              <el-tab-pane label="公告" name="2"></el-tab-pane>
            </el-tabs>
            <el-card :body-style="{padding: '0px'}" style="height: 320px;border-radius: 0 !important;" class="animated fadeInUp card-box-shadow">
              <el-table
                ref="refTable"
                :data="noticeData"
                size="mini"
        ...
        <el-col :span="8" v-show="userType == 2">
          ...
          <el-card :body-style="{padding: '0px'}" class="margin-top-20 animated fadeInUp card-box-shadow" style="height: 500px;overflow-y: auto">
            <div slot="header" class="moon-clearfix padding-tb-10 padding-lr-10">
              <span class="color-muted" style="font-weight: bold;position: relative; top: 5px;">
                <i class="fa fa-line-chart"></i>
                <span>{{$t("设备状态")}}</span>
        ...
        <el-col :span="8" v-if="userType == 4">
          ...
          <el-card :body-style="{padding: '0px'}" class="margin-top-20 animated fadeInUp card-box-shadow" style="height: 500px;overflow-y: auto" v-if="userType == 4">
            <div slot="header" class="moon-clearfix padding-tb-10 padding-lr-10">
              <span class="color-muted" style="font-weight: bold;position: relative; top: 5px;">
                <i class="fa fa-line-chart"></i>
                <span>{{$t("素质学分动态")}}</span>
