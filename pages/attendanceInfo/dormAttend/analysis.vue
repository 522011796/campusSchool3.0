    ...
    <layout-lr>
      ...
      <div slot="right">
        <div>
          ...
          <my-search-of-date-group size="small" :show-day="false" :show-year="false" :sel-date-time="searchTopTime" @click="searchTopDate" @type-click="searchTopType"></my-search-of-date-group>
        </div>
