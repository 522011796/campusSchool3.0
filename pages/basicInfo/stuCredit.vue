<template>
  <div class="container">
    <layout-tb>
      <template slot="tag">素质学分申请</template>
      ...
      <div slot="content">
        ...
        <el-form ref="form" :rules="rules" :model="form" label-width="80px">
          ...
          <el-form-item label="条件" prop="conditionType">
            <my-select width-style="260" :sel-value="form.conditionType" :options="filterScoreFlowTypes" @change="handleChangeSelect($event)"></my-select>
          </el-form-item>
