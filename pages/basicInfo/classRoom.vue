        ...
        <div class="layout-right-tab margin-top-10">
          <el-row>
            <el-col :span="12">
              ...
              <el-button size="small" type="warning" plain  icon="el-icon-notebook-2">{{$t("导入教室")}}</el-button>
            </el-col>
            <el-col :span="12" class="text-right">
              <MyInputButton size="small" plain width-class="width: 150px" type="success" :clearable="true" @click="search"></MyInputButton>
            </el-col>
          </el-row>
        </div>
...
export default {
  mixins: [mixins],
  components: {MyElTree,MyInputButton,MyPagination,LayoutLr,DialogNormal,MyNormalDialog},
  data(){
    return {
