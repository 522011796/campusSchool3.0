      ...
      <div slot="content">
        ...
        <el-form ref="form" :rules="rules" :model="form" label-width="80px">
          <el-form-item label="申请类型">
            <label class="color-success">{{$t("教师补卡申请")}}</label>
          </el-form-item>
          ...
          <el-form-item label="条件" prop="conditionStatus">
            <div>
              <my-select width-style="300" :sel-value="form.conditionStatus" :options="filterCardFlowTypes" @change="handleChangeSelect($event)"></my-select>
            </div>
            <!--<el-button-group>
