  ...
  <div>
    <div class="text-left" v-bind="selectDetailType">
      <el-button-group>
        ...
        <el-button v-if="formCode != 'TYHT' && ((extraDataList && extraDataList.length > 0) || (serialDataList && serialDataList.length > 0))" size="small" :type="detailDataType == 3 ? 'primary' : 'default'" @click="changeDetailType($event ,3)">{{ $t("单据列表") }}</el-button>
      </el-button-group>
    </div>
          ...
          <div class="margin-top-10">
            <el-table
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <el-popover trigger="hover" placement="top" popper-class="custom-table-popover">
                    <div class="text-center">{{scope.row['applyData'] && scope.row.applyData['ht_name20230501'] ? scope.row.applyData['ht_name20230501'].value : '--'}}</div>
                    <div slot="reference" class="name-wrapper moon-content-text-ellipsis-class">
                      <span>{{scope.row['applyData'] && scope.row.applyData['ht_name20230501'] ? scope.row.applyData['ht_name20230501'].value : '--'}}</span>
                    </div>
                  </el-popover>
                </template>
              </el-table-column>
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <el-popover trigger="hover" placement="top" popper-class="custom-table-popover">
                    <div class="text-center">{{scope.row['applyData'] && scope.row.applyData['ht_amount20230501'] ? scope.row.applyData['ht_amount20230501'].value: '--'}}</div>
                    <div slot="reference" class="name-wrapper moon-content-text-ellipsis-class">
                      <span>{{scope.row['applyData'] && scope.row.applyData['ht_amount20230501'] ? scope.row.applyData['ht_amount20230501'].value: '--'}}</span>
                    </div>
                  </el-popover>
                </template>
              </el-table-column>
            ...
            <el-table
              v-else-if="formCode == 'CGHT' || formCode == 'XSHT'"
              :data="tableOrderDetailData"
              header-cell-class-name="custom-table-cell-bg"
              size="small"
              border
