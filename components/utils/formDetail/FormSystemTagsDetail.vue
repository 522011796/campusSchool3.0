  ...
  <div>
    <div class="text-left" v-bind="selectDetailType">
      <el-button-group>
        ...
        <el-button v-if="dataMainDetailObj.formCode != 'TYHT'" size="small" :type="detailDataType == 3 ? 'primary' : 'default'" @click="changeDetailType($event ,3)">{{ $t("单据信息") }}</el-button>
      </el-button-group>
    </div>
          ...
          <div class="margin-top-20">
            ...
            <template>
              <div class="margin-top-5">
                ...
                <template v-if="dataMainDetailObj.formCode == 'XSHT' || dataMainDetailObj.formCode == 'CGHT' || dataMainDetailObj.formCode == 'TYHT'">
                  <div>
                    1
                  </div>
                </template>
