  ...
  methods: {
    lineChart(){
      ...
      let schema = [
        ...
        {name: 'A', index: 1, text: '出勤率'},
        {name: 'B', index: 2, text: '缺勤率'},
        {name: 'C', index: 3, text: '正常'},
        {name: 'D', index: 4, text: '迟到'},
        {name: 'E', index: 5, text: '早退'},
        {name: 'F', index: 6, text: '请假'},
        {name: 'G', index: 7, text: '旷课'}
      ];
